...
class FAQChatbot:
    FAQ_DATABASE = [
        ...
        {'question': 'Can I schedule recurring appointments with WasteBuddy?', 'answer': 'Yes, you can schedule recurring appointments for waste collection or other services with WasteBuddy.'},
        {'question': 'How can I cancel my appointment with WasteBuddy?', 'answer': 'You can cancel your appointment with WasteBuddy by logging into your account on our website and selecting the option to cancel your appointment.'},
